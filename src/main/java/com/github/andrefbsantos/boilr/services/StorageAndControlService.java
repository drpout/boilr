...
public class StorageAndControlService extends Service {
	...
	private void populateDB() {
		...
		try {
			Alarm alarm = new PriceHitAlarm((int) generateAlarmID(), new BitstampExchange(10000000), new Pair("BTC", "USD"), 1000000, new AndroidNotify(), 10000, 300);
			AlarmWrapper wrapper = new AlarmWrapper(alarm);
			addAlarm(wrapper);

			alarm = new PriceHitAlarm((int) generateAlarmID(), new BTCEExchange(10000000), new Pair("BTC", "EUR"), 1000000, new AndroidNotify(), 800, 100);
			wrapper = new AlarmWrapper(alarm);
			addAlarm(wrapper);

			alarm = new PriceHitAlarm((int) generateAlarmID(), new BTCChinaExchange(10000000), new Pair("BTC", "CNY"), 1000000, new AndroidNotify(), 10000, 500);
			wrapper = new AlarmWrapper(alarm);
			addAlarm(wrapper);
